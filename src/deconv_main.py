...
# from src.deconv.deconv_estimate import estimate_celltype_assignment
# import pandas as pd
# import numpy as np
...
#     input_vcf_filename = os.path.basename(vcf_file).split(".")[0]
#     output_vcf = f"{output}/{input_vcf_filename}.celltype_annotated.vcf"
...
#     estimate_celltype_assignment(vcf_file, summary_classification_df, celltypes, output_vcf)
